...
#nest.SetKernelStatus({"resolution": dt}) #TODO: uncomment
...
#espikes.set(label="brunel-py-ex", record_to="ascii")# TODO: uncomment
#ispikes.set(label="brunel-py-in", record_to="ascii")# TODO: uncomment
...
print('Done setting up the brunel network.')

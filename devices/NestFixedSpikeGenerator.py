...
import common.devices.AbstractBrainDevice as AbstractBrainDevice
from common.devices.BrainInterface import IFixedSpikeGenerator
from devices.NestDictParser import set_synapse_type, set_connector
import numpy as np
...
class NestFixedSpikeGenerator(AbstractBrainDevice, IFixedSpikeGenerator):
    ...
    def get_id(self):# TODO: duplicated in other concrete devices, move to base class
        """
        Returns device id
        :return NodeCollection type representing device (node) id
        """
        return _generator
